...
class SpeechRecognitionThread(QThread):
    """Thread for speech recognition using Whisper"""
    transcribed = pyqtSignal(str)
    status = pyqtSignal(str)
    listening_progress = pyqtSignal(int)  # For countdown
    ...
    def __init__(self):
        ...
        try:
            ...
            self.status.emit(f"Error loading Whisper model: {str(e)}")
        ...
        while self.running:
            try:
                ...
                try:
                    ...
                    self.status.emit(f"Transcription error: {str(e)}")     
...
class VoiceAssistantApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle("Voice Assistant (Whisper)")
        ...
        # Welcome message
        self.add_assistant_message("Hello! I'm your voice assistant powered by Whisper. Click 'Start Listening' and speak to me, or type a message.")
